...
public class KafkaDataProducer {
	...
	private void init (){
		...
		props.put("partitioner.class", TopicParitioner.class);
	...
	*/	
	public void produceData(int totalMessagesToSend) {
		...
		.forEach(i-> {
			...
			kafkaProducer.send(new ProducerRecord<String, String>("Kafka-Topic", "Google","This is message number ".concat(String.valueOf(i))));
		});
		}
		finally {
			kafkaProducer.close();
